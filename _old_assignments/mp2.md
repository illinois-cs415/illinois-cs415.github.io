...
**Part 1** covers creating the map, health system, collectibles, and the Pursuer enemy type.
...
<br/><br/>
**Part 2** covers creating the Mortar and custom enemies, level restart, and putting the pieces of the level all together.
...
## Part 1: Player Character, Health System, Collectibles, Pursuer Enemy (Due Feb. 14)
...
<img src="../img/assignments/mp2/pursuer%20tutorial/step6.png" alt="drawing" width="800"/>
...
<img src="../img/assignments/mp2/pursuer%20tutorial/step8.png" alt="drawing" width="600"/>
...
<img src="../img/assignments/mp2/pursuer%20tutorial/step7.png" alt="drawing" width="800"/>

### Step 8: Create an Enumerator Class
*We can create an enumerator class to help us keep track of the state of the Pursuer.*
...
<img src="../img/assignments/mp2/pursuer%20tutorial/step9a.png" alt="drawing" width="400"/>

Add two enumerators: `Roam` and `Chase Player`. 

<img src="../img/assignments/mp2/pursuer%20tutorial/step9b.png" alt="drawing" width="600"/>
...
<img src="../img/assignments/mp2/pursuer%20tutorial/step9c.png" alt="drawing" width="400"/>

Remove the connection between "Event BeginPlay" and "ChasePlayer". Drag from "Event BeginPlay" and type "Switch on EAIState". The AIState variable will be connected to the "Selection" node on "Switch on EAIState". Attach a 'Roam' event block to the 'Roam' node and a 'Chase Player' block to 'Chase Player'. This will control what action your Pursuer does when the game starts.

<img src="../img/assignments/mp2/pursuer%20tutorial/step9d.png" alt="drawing" width="600"/>

Note that updating the value of AI State only changes the variable value. To update the character's behavior, you will still need to call the corresponding event.
...
<img src="../img/assignments/mp2/pursuer%20tutorial/step9e.png" alt="drawing" width="800"/>
...
<img src="../img/assignments/mp2/pursuer%20tutorial/step3.png" alt="drawing" width="400"/>

Pawn sensing allows the character to see and hear within a specified radius and angle. Look at the events that come with Pawn Sensing and find the one that is triggered when the Pursuer sees the player. Think about how you might use this to call a Chase event.
...
In addition to the instructions above, the following set of tutorials may be helpful to you for implementing the Pursuer: 
...
* [Unreal Engine 4 - AI Patrol](https://youtu.be/WDzIk7dP4d4?si=UdwyLtw0Qdg0Pb_k)
...
## Part 2: Mortar Enemy, Custom Enemy, Level Restart, Completing the Level (Due Feb. 24)
...
When the Game Over or Level Complete screen is displayed, the player should have the option to restart the game without exiting. Upon the restart, all the characters and assets should be returned to their initial locations, and health and score should be reset to 0.
...
- If the projectile is going through instead of colliding with the ground:
  - Make sure that both the projectile and map collisions are set to `BlockAllDynamic` in their Details panel
  - Try replacing DefaultSceneRoot in `BP_Projectile` with the sphere collision
  - Make sure hit detection is enabled during physics simulation
